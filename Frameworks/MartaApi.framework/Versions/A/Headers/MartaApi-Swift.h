...
SWIFT_MODULE_NAMESPACE_PUSH("MartaApi")



@interface NSColor (SWIFT_EXTENSION(MartaApi))
/// Get the hex String value for this <code>NSColor</code>.
/// This returns the “#rrggbb” string (without the opacity).
@property (nonatomic, readonly, copy) NSString * _Nonnull hexValue;
/// Parses the <code>NSColor</code> from the given <code>hexString</code>.
/// Allowed String formats: “#rrggbb” or “#aarrggbb”.
+ (NSColor * _Nonnull)fromHexString:(NSString * _Nonnull)hexString SWIFT_WARN_UNUSED_RESULT;
/// Converts the given <code>hexInt</code> to <code>NSColor</code>.
/// \param hexInt the color to convert.
///
/// \param useAlpha true if the alpha bits should be preserved.
///
+ (NSColor * _Nonnull)fromHex:(NSInteger)hexInt useAlpha:(BOOL)useAlpha SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC8MartaApi9SmartMenu")
@interface SmartMenu : NSMenu
